...
\begin{frame}{Analyse syntaxique}
	\only<1-5>{
		...
		\end{forest}
		\caption*{Une autre réprésentation}
\end{figure}
}
\end{column}
\end{columns}
...
\begin{frame}{À vous de jouer !}
	...
	\only<2->{
		%TODO!! I cannot leave this here - it says delft trial lecture :)
		\begin{figure}
			\centering
			\includegraphics[scale=0.3]{images/quizalize.png}
		\end{figure}
	}
...
\only<9>{
	%TODO: ideally redo this in a separate frame that does not say parsing with recurrent neural netsA - but then I would also need proper citation for it
				\begin{figure}
						\centering
						\includegraphics[scale=0.4]{images/architecture_transformers}
				\end{figure}
			}
...
\begin{frame}{Constituency parsing with neural networks}
	%TODO: make sure I really get how this works
	...
	\end{figure}
		...
		\vspace{0.5cm}
		\tiny{
		\textcite{kitaev-klein-2018-constituency}
		}
	}
	...
	\begin{figure}
			\centering
			\includegraphics[scale=0.2]{images/rnng}
	\end{figure}

		\vspace{1.5cm}
		\tiny{
		\textcite{dyer-etal-2016-recurrent}
		}
	}
\end{overlayarea}
\end{frame}
